        ...
        <div className="fixed inset-0 bg-foreground/50 backdrop-blur-sm z-50 flex items-center justify-center p-4" onClick={(e) => { if (e.target === e.currentTarget) onClose(); }}>
            <div className="bg-background rounded-2xl w-full max-w-2xl overflow-hidden shadow-2xl animate-in fade-in zoom-in-95 duration-200">
                <div className="flex items-center justify-between p-6 border-b border-border">
                    <div>
                        <h2 className="text-xl font-bold">Video Showcase Section</h2>
                        <p className="text-xs text-muted-foreground mt-1">Manage the two-column showcase grid content</p>
                    </div>
                ...
                <div className="p-6 max-h-[70vh] overflow-y-auto">
                            ...
                            {[
                                {
                                    id: 'grid-2-col',
                                    label: '2-Column Grid',
                                    desc: 'Equal width 50/50 side-by-side display.',
                                    preview: (
                                ...
                                {
                                    id: 'masonry',
                                    label: 'Masonry Asymmetric',
                                    desc: 'Dynamic grid. Large video column, small image column.',
                                    preview: (
                                ...
                                },
                                {
                                    ...
                                    desc: 'Full width video top, full width image bottom.',
                                    preview: (
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="col-span-2">
                            <label className="block text-xs font-bold text-foreground/80 uppercase tracking-wider mb-2">Section Title</label>
                            <input
                                type="text"
                        ...
                        <div className="col-span-2">
                            <label className="block text-xs font-bold text-foreground/80 uppercase tracking-wider mb-2">Section Subtitle</label>
                            <input
                                type="text"
                                className="w-full px-4 py-2 border border-border rounded-lg focus:outline-none focus:border-foreground transition-colors"
                        ...
                        <div className="col-span-2 md:col-span-1 p-4 border border-border rounded-xl bg-muted/50 space-y-4">
                            <h4 className="font-bold text-sm mb-2 flex items-center gap-2"><FiVideo /> Left Column (Video)</h4>
                            <div>
                                <label className="block text-[10px] font-bold text-muted-foreground uppercase tracking-wider mb-1">Video Upload</label>
                                <VideoUpload
                            ...
                            <div>
                                <label className="block text-[10px] font-bold text-muted-foreground uppercase tracking-wider mb-1">Hover Label</label>
                                <input
                                    type="text"
                        ...
                        {/* Image Column */}
                        <div className="col-span-2 md:col-span-1 p-4 border border-border rounded-xl bg-muted/50 space-y-4">
                            <h4 className="font-bold text-sm mb-2 flex items-center gap-2"><FiImage /> Right Column (Image)</h4>
                            <div>
                                <label className="block text-[10px] font-bold text-muted-foreground uppercase tracking-wider mb-1">Image Upload</label>
