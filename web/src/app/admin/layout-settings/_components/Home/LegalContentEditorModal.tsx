...
export default function LegalContentEditorModal({ onClose, onUpdate, instanceId }: LegalContentEditorModalProps) {
    ...
    const editor = useEditor({
        ...
        editorProps: {
            attributes: {
                class: 'legal-rich-text prose prose-sm sm:prose-base prose-headings:text-foreground prose-p:text-foreground prose-li:text-foreground focus:outline-none min-h-[400px] p-8 max-w-none transition-colors border-none',
            },
        },
    });
