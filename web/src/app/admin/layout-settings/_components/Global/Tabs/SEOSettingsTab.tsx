        ...
        <div className="space-y-8 animate-in fade-in duration-300">
            ...
            <div className="p-8 rounded-3xl border border-border/50 flex flex-col md:flex-row justify-between items-center gap-6 shadow-xl relative overflow-hidden bg-muted/5 group transition-all duration-500 hover:shadow-2xl">
                ...
                <div className="relative z-10 text-center md:text-left">
                    <span className="text-[10px] font-bold tracking-[0.3em] text-primary uppercase mb-2 block">{t('admin.seo')}</span>
                    <h4 className="font-bold text-2xl text-foreground mb-2 tracking-tight serif italic">{t('admin.searchEngineOptimization')}</h4>
                    <p className="text-xs text-muted-foreground opacity-70 max-w-sm leading-relaxed">Optimize how your store appears in Google and social media search results.</p>
                </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-6">
                    <div>
                        <label className="text-[10px] font-bold uppercase text-muted-foreground mb-2 block">{t('admin.metaTitle')}</label>
                        <input
                        ...
                        <div className="flex justify-between items-center mt-2 px-1">
                            <p className="text-[9px] text-muted-foreground">Appears as the page title in search results.</p>
                    ...
                    <div>
                        <label className="text-[10px] font-bold uppercase text-muted-foreground mb-2 block">{t('admin.metaDescription')}</label>
                        <textarea
                            rows={4}
                        ...
                        />
                        <div className="flex justify-between items-center mt-2 px-1">
                            <p className="text-[9px] text-muted-foreground">A brief summary of your site for search engines.</p>
                ...
                <div className="space-y-6">
                    <div>
                        <label className="text-[10px] font-bold uppercase text-muted-foreground mb-2 block">Keywords (Optional)</label>
                        <input
                        ...
                        />
                        <p className="text-[9px] text-muted-foreground mt-2 px-1">Using the tagline as base keywords for extra context.</p>
                    </div>
                    ...
                    <div className="p-5 bg-blue-50/50 border border-blue-100 rounded-2xl space-y-3">
                        ...
                        <div className="space-y-1">
                            ...
                            <div className="text-gray-600 text-[11px] line-clamp-2 leading-relaxed">
                                {settings.metaDescription || 'Add a meta description to see how your site will appear in Google search results.'}
                            </div>
                        </div>
                    </div>
                </div>
