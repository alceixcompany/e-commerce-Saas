...
export const getInitialSectionsConfig = (t: Translate): Record<string, PageSection[]> => ({
    global: [
        ...
        { id: 'security', label: t('admin.globalSettings.security.title') || 'Security', description: t('admin.globalSettings.security.description'), isActive: true, hasSettings: true },
    ],
    home: [],
    shop: [],
    product: [],
