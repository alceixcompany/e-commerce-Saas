...
interface CartClientProps {
  serverRecommendations?: Product[];
}

export default function CartClient({ serverRecommendations = [] }: CartClientProps) {
  ...
  const recommendations = useMemo<Product[]>(() => {
    // Filter out items already in cart from either server recommendations or empty list
