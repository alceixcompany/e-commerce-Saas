...
export default function HeroSection() {
  return (
    <div className="relative h-[80vh] md:h-[85vh] min-h-[500px] md:min-h-[600px] w-full flex items-center justify-center overflow-hidden bg-background">
      {/* Background Video */}
      ...
      {/* Content Overlay */}
      <div className="relative z-10 w-full h-full flex flex-col items-center justify-end pb-20 md:pb-32 text-center text-background">
        <div className="max-w-2xl px-6">
          ...
          <Link
            href="/collections"
            className="inline-block bg-primary text-background px-8 py-3 md:px-10 md:py-4 transition-all duration-300 font-light tracking-[0.2em] uppercase text-[10px] md:text-xs hover:bg-primary/90"
          >
