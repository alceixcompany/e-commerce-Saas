...
const createOrderValidators = [
    ...
    body('legalConsents.preInformationAccepted', 'Preliminary Information Form must be accepted').equals('true'),
    body('legalConsents.distanceSalesAccepted', 'Distance Sales Agreement must be accepted').equals('true'),
